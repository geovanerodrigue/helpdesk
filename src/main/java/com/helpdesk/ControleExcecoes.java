...
import com.helpdesk.model.dto.ObjetoErroDTO;
...
public class ControleExcecoes extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(ExceptionHelpDesk.class)
	public ResponseEntity<Object> handleExceptionCustom(ExceptionHelpDesk ex) {
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		if(ex instanceof MethodArgumentNotValidException) {
			...
			msg = "Não está sendo enviado dados para o Body corpo da requição";
		...
		ex.printStackTrace();
		try {
			serviceSendEmail.enviarEmailHtml("Erro na loja virtual", ExceptionUtils.getStackTrace(ex), "geovane.net@live.com");
